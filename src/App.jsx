      ...
      <Router>
        <div style={{ padding: "20px", fontSize: "13px", fontWeight: "light" }}>
          ...
          <div style={{ padding: "20px", display: "flex", gap: "10px" }}>
            ...
            <h2
              className={activePart === "performance" ? "tbactive" : "tbinactive"}
              onClick={() => setActivePart("performance")}
            >
              Performance
            </h2>
          </div>
          ...
          {activePart === "performance" && (
            <ul className="listitems">
              {experformance.map((example) => (
                <li key={example.id}>
                  <Link to={`/experformance/${example.id}/${example.title}`}>{example.title}</Link>
                </li>
              ))}
            </ul>
          )}
          ...
          <Routes>
            ...
            <Route path="/experformance/:id/:title" element={<ExPagePerformance />} />
